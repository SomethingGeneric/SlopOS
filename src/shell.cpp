...
void shell_execute_command(const char* command) {
    if (strcmp(command, "version") == 0) {
        execute_version_command(write_string);
    } else if (strcmp(command, "hello") == 0) {
        execute_hello_command(write_string);
    } else if (strcmp(command, "ps") == 0) {
        execute_ps_command(write_string);
    } else if (strcmp(command, "uptime") == 0) {
        execute_uptime_command(write_string);
    } else if (strcmp(command, "help") == 0) {
        execute_help_command(write_string);
    } else if (strcmp(command, "memory") == 0) {
        execute_memory_command(write_string);
    } else if (strcmp(command, "yield") == 0) {
        execute_yield_command(write_string);
